...
// Target backend. Defaults to the published host port; run-loadtest.sh sets
// TARGET=http://lb:9999 to hit the LB container from inside the compose network.
const TARGET = __ENV.TARGET || 'http://localhost:9999';
...
export function handleSummary(data) {
    ...
    return {
        'loadtest/results.json': JSON.stringify(result, null, 2),
